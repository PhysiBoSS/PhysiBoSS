...
void create_cell_types( void )
{
	...
	*/ 
	...
	// cell_defaults.functions.update_phenotype = tumor_cell_phenotype_with_signaling; // XXX past
...
void setup_microenvironment( void )
{
	...
	// initialize BioFVM 	initialize_microenvironment(); 	
